...
class FindInPage extends Find {
    constructor(webContents, options = {}) {
        ...
        this.duration =
            typeof options.duration === "number" && options.duration > 0 ? options.duration : 300;
...
function getUserConfig(options) {
    ...
    this[config].offsetRight =
        typeof options.offsetRight === "number" ? `${options.offsetRight}px` : "5px";
    this[config].boxBgColor = typeof options.boxBgColor === "string" ? options.boxBgColor : "#fff";
    this[config].boxShadowColor =
        typeof options.boxShadowColor === "string" ? options.boxShadowColor : "#909399";
    ...
    this[config].inputFocusColor =
        typeof options.inputFocusColor === "string" ? options.inputFocusColor : "#c5ade0";
    this[config].textColor = typeof options.textColor === "string" ? options.textColor : "#606266";
    this[config].textHoverBgColor =
        typeof options.textHoverBgColor === "string" ? options.textHoverBgColor : "#eaeaea";
    this[config].caseSelectedColor =
        typeof options.caseSelectedColor === "string" ? options.caseSelectedColor : "#c5ade0";
}
...
function onInput() {
    ...
    this.previousInputTimeouts.push(
        setTimeout(() => {
